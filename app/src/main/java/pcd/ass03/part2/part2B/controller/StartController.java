...
public class StartController {
    ...
    public StartController(StartView startView, RMI user) {
            ...
            do {
                ...
                if (!gameCode.trim().isEmpty()) {
                        if (user.isPresent(gameCode)) {
                            ...
                            //CAMBIA DA QUI
                            detailsView = new GameView(user.getUsername(), gameCode);
            ...
            do {
                ...
                if (!gameCode.trim().isEmpty()) {
                    if (!user.isPresent(gameCode)) {
                        ...
                        GameView gameView = new GameView(user.getUsername(), gameCode);
